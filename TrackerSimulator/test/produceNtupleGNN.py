...
if __name__ == "__main__":
    ...
    while eventCounter < int(opts.nEvents):
        ...
        while trackCounter < int(opts.nTracks):
            ...
            hx.extend(track.xm.tolist())
            hy.extend(track.ym.tolist())
            hz.extend(track.zm.tolist())
        ...
        hx.extend(noise.xm.tolist())
        hy.extend(noise.ym.tolist())
        hz.extend(noise.zm.tolist())
